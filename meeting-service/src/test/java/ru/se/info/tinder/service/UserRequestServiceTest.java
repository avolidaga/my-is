...
class UserRequestServiceTest {
    ...
    void setUp() {
        ...
        userRequest = UserRequest.builder()
                .userRequestId(1L)
                .spacesuitData(meeting)
                .status(RequestStatus.NEW)
                .createdAt(LocalDateTime.now())
                .updatedAt(LocalDateTime.now())
                .build();

        userRequestDto = MeetingParticipantMapper.toUserRequestDto(userRequest);
    }
    ...
    void createUserRequest_shouldCreateNewRequest() {
        ...
        StepVerifier.create(userRequestService.createUserRequest(meeting))
